...
namespace E20R\Sequences\Utilities;

// Disallow direct access to the class definition
use E20R\Sequences\Sequence\Sequence_Controller;

if ( ! defined( 'ABSPATH' ) ) {
	wp_die( __( "Cannot access file directly", Sequence_Controller::plugin_slug ) );
}

if ( ! class_exists( 'E20R\Sequences\Utilities\Utilities' ) ) {
