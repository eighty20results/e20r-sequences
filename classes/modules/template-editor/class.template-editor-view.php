            ...
            <tr>
                ...
                <td class="e20r-hidden-template-settings">
                    <table class="e20r-message-settings">
                        <tbody>
                        <form action="" method="post" enctype="multipart/form-data" id="e20r-message-templates-form_<?php esc_attr_e( $template_name ); ?>">
	...
	public static function add_template_entry( $template_name, $template, $return = false ) {
	    ...
	    if ( true === $return ) {
            ...
            <tr class="e20r-start-hidden e20r-message-template-name_<?php esc_attr_e( $template_name ); ?>">
                <input type="hidden" name="e20r_message_template-file_name" value="<?php esc_attr_e( $template['file_name'] ); ?>">
                <input type="hidden" name="e20r_message_template-key" value="<?php esc_attr_e( $template_name ); ?>">
                <input type="hidden" name="e20r_message_template-file_path" value="<?php esc_attr_e( $template['file_path'] ); ?>">
                <input type="hidden" name="e20r_message_template-description" value="<?php esc_attr_e( $template['description'] ); ?>">
						...
						foreach ( $template['schedule'] as $days ) { ?>
                            <div class="e20r-schedule-entry">
                                ...
                                <span class="e20r-message-schedule-remove">
                                                        <input type="button" value="<?php _e( "Remove", Payment_Warning::plugin_slug ); ?>" class="e20r-delete-schedule-entry button-secondary" />
                                                    </span>
                            </div>
						<?php }
            ...
            <tr class="e20r-start-hidden e20r-message-template-name_<?php esc_attr_e( $template_name ); ?>">
                ...
                <td class="e20r-message-template-col">
                    <input id="e20r-message-disabled_<?php esc_attr_e( $template_name ); ?>"
                           name="e20r_message_template-active" type="checkbox" value="1" <?php checked( $template['active'], 0 ); ?> />
                    <label>
            ...
            <tr class="e20r-message-template-name_<?php esc_attr_e( $template_name ); ?> e20r-start-hidden">
                <td colspan="2" class="e20r-message-template-col"><hr /></td>
            </tr>
        <?php
